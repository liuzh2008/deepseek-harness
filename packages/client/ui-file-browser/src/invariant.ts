...
/**
 * No runtime invariant: the plugin registers one sidebar footer action whose
 * disposal the HMR-safety spec proves, and every listing it shows is re-read
 * from the Host on demand rather than held here.
 */
