...
import fileBrowserRemote from '@deepseek-ai/dsh-host-file-browser/remote'
...
export type {} from '@deepseek-ai/dsh-host-file-browser/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, fileBrowserRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
